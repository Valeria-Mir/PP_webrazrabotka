...
/* ===== ТЕМНАЯ ТЕМА ===== */
.site-full.dark-mode .mobile-menu {
  background: #0d0d0d;
}

.site-full.dark-mode .mobile-menu-close {
  background: #1a1a1a;
  color: #e0e0e0;
}

.site-full.dark-mode .mobile-menu-close:hover {
  background: #cc0000;
  color: white;
}

.site-full.dark-mode .mobile-menu-logo {
  border-bottom-color: rgba(255, 255, 255, 0.05);
}

.site-full.dark-mode .mobile-menu-logo span {
  color: #f0f0f0;
}

.site-full.dark-mode .mobile-menu-section a {
  color: #cccccc;
}

.site-full.dark-mode .mobile-menu-section a:hover {
  color: #cc0000;
}

.site-full.dark-mode .mobile-menu-title {
  color: #cc0000;
}

.site-full.dark-mode .mobile-menu-contacts {
  border-top-color: rgba(255, 255, 255, 0.05);
}

.site-full.dark-mode .mobile-phone {
  color: #e0e0e0;
}

.site-full.dark-mode .mobile-email {
  color: #888;
}

.site-full.dark-mode .mobile-phone:hover,
.site-full.dark-mode .mobile-email:hover {
  color: #cc0000;
}
</style>